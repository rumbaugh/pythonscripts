...
class Image:
   ...
   def display(self, hext=0, wtfile=None, cmap='gaia', absrange=None, siglow=1.0, sighigh=10.0, statsize=2048, title=None, subimdef='xy', 
      ...
      if absrange is not None:
         ...
         if self.found_rms == False:
            ...
            print "--------------------------"
            self.mean_clip,self.rms_clip = ccd.sigma_clip(self.subim,verbose=True)
            self.found_rms = True
